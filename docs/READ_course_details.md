...
- **3 classes per week** total, including: 
  - **Mondays**: 1 class of instructional activities and discussions
  - **Wednesdays**: 1 class of coding workshop activities and tutorials
  - **Fridays**: 1 weekly 'lab' of coding activities
